...
+ (void)refreshAccessToken:(NSString * _Nullable)refreshToken completionHandler:(void (^ _Nonnull)(LineSDKAccessToken * _Nullable, NSError * _Nullable))completion;
+ (void)refreshAccessToken:(NSString * _Nullable)refreshToken callbackQueue:(LineSDKCallbackQueue * _Nonnull)queue completionHandler:(void (^ _Nonnull)(LineSDKAccessToken * _Nullable, NSError * _Nullable))completion;
...
@interface LineSDKLoginButton : LoginButton
...
@property (nonatomic, copy) NSArray<LineSDKLoginManagerOptions *> * _Nullable loginManagerOptions;
...
SWIFT_CLASS("_TtC11LineSDKObjC26LineSDKLoginManagerOptions")
...
- (nonnull instancetype)initWithLabel:(NSString * _Nonnull)label uri:(NSURL * _Nonnull)uri OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
